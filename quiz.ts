    ...
    if (topics.topic === "Data types") {
      ...
      let datatypes = await inquirer.prompt([
        {
          ...
          type: "list",
          message:
            "Q1. What is the data type of the following variable declaration in TypeScript?    let person: { name: string, age: number } = { name: 'Bob', age: 25 };",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q2. What the answer of the following typescript code ? let num:string = 100   console.log(num)",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q3. What is the output of the following code ? console.log(typeof(100))",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q4. Which of the following  is a primitive data type in typescript ?",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q5. Which data type represent a collection of ordered values ?",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q6. Which data type is used to represent logical True and False values ?",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q7. Which data type is used to represent a collection of Key pair values ?",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q8. How can you access the type information of a variable at runtime in TypeScript? ",
          choices: [
            "typeof variable",
            " variable.type ",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q9. What is the data type of the following variable declaration in TypeScript?   let colors: string[] = ['red', 'blue', 'green'] ",
        ...
        },
        {
          ...
          type: "list",
          message:
            " Q10. Which data type is used to represent whole numbers in TypeScript?",
      ...
      let functions = await inquirer.prompt([
        ...
        },
        {
          ...
          name: "Q2",
          message:
            "Q2. What is the output of the following code snippet?   function greet(name: string): string {  return `Hello, ${name}!`; }     console.log(greet('Alice'));",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q3. WhatWhat is the correct way to call a upper  function with default parameters in TypeScript?",
          choices: [
            "greet()",
            "greet('Alice', 'Bob')",
            "greet('Alice')",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q4.What is the output of the following code snippet? function multiply(a: number, b: number = 2): number {   return a * b; } console.log(multiply(3)); ",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q5. Which of the following is true about higher-order functions in TypeScript?",
          choices: [
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q6. What keyword is used to define a function in TypeScript?",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q7. What is the output of the following code snippet?   const add = (a: number, b: number): number => a + b;    console.log(add(2, 3, 4));",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q10.Which TypeScript feature allows a function to accept a variable number of arguments?",
          choices: [
      ...
      if (functions.Q8 === "using the => syntax after the parameter") {
        ...
        console.log(
          "The correct answer of Q8 is using the => syntax after the parameter"
        );
      }
      ...
      let array = await inquirer.prompt([
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q3. How do you access an element in an array in TypeScript?",
          choices: [
            "myArray[0]", //
            "myArray(0)",
            "myArray.get(0)",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q6. How do you check if an array contains a specific value in TypeScript?",
          choices: [
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q7. Select the answer of code : let myArray: number [ ] = [10, 15, 20, 25];   myArray.unshift('70' );  console.log(myArray)",
          choices: [
            "[70, 10, 15, 20, 25]", //
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q8. What method removes the last element of an array in TypeScript?",
          choices: [
            "pop()", //
        ...
        },
        {
          ...
          type: "list",
          message:
            "09. What will be the output of the following TypeScript Code?    let myArray: number  [ ] = [1, 5, 2, 2];   myArray.push(7);  console.log(myArray)",
          choices: [
            "[ 1, 5, 2, 2, 7 ]", //
        ...
        },
        {
          ...
          type: "list",
          message:
            "10. What will be the output of the following TypeScript Code?  let myArray: number  [ ] = [1, 2, 3, 4];    myArray.pop();  console.log(myArray)",
          choices: [
            " [2, 3, 4]",
      ...
      if (array.Q1 === " A collection of elements of the same type") {
        ...
        console.log(
          "The correct answer of Q1 is :  A collection of elements of the same type"
        );
      }
      ...
      if (array.Q6 === "if (myArray.includes(value))") {
        ...
        console.log(
          "The correct answer of Q6 is : if (myArray.includes(value))"
        );
      }
      ...
      let operators = await inquirer.prompt([
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q2. What is the difference between == and === operators in TypeScript?          ",
          choices: [
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q6.What is the difference between || and | operators in TypeScript?  ",
          choices: [
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q7. What is the difference between >= and = operators in TypeScript? ",
          choices: [
            " No difference            ",
            "Not sure            ",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q8.  What is the purpose of the **= operator in TypeScript?",
          choices: [
            "Modulus assignment",
        ...
        },
        {
          ...
          type: "list",
          message:
            "Q10.Which operator is used for string concatenation in TypeScript?",
          choices: ["+", "-", "%", "^"],
        },
      ]);
      ...
      if (operators.Q2 === "== checks value, === checks value and type") {
        ...
        console.log(
          "The correct answer of Q2 is : == checks value, === checks value and type"
        );
      }
      ...
      if (
        ...
        console.log(
          "The correct answer of Q6 is : || is the logical OR operator, | is the bitwise OR operator"
        );
      }
      if (
        operators.Q7 ===
        ...
        console.log(
          "The correct answer of Q7 is :   >= checks greater than or equal, > checks greater than"
        );
      }
